    ...
    private void btnStartStopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartStopActionPerformed
        try {
            ...
            if (!parent.getConfigureDBPanel().isFilled()) {
                JOptionPane.showMessageDialog(parent, "Niste uneli podatke za konfiguraciju baze podataka!", "Greška", JOptionPane.ERROR_MESSAGE);
                return;
            }
            if (!parent.getConfigurePortPanel().isFilled()) {
                JOptionPane.showMessageDialog(parent, "Niste uneli podatke za konfiguraciju broja porta!", "Greška", JOptionPane.ERROR_MESSAGE);
                return;
            }
